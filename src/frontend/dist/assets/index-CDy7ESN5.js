...
function App() {
  ...
  const [rollCode, setRollCode] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col font-body bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `relative overflow-hidden text-white text-center py-3 px-4 text-sm font-bold ${isLive ? "bg-green-600" : "bg-gradient-to-r from-red-600 via-orange-500 to-red-600"}`,
        style: {
          animation: isLive ? "none" : "pulse-bg 2s ease-in-out infinite"
        },
        "data-ocid": "alert.section",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4", children: isLive ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base animate-bounce", children: "🟢 RESULT LIVE HO GAYA! Abhi Check Karein — Official Site Open Karein!" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
              ...
              "🔴 BREAKING NEWS: Bihar Board Intermediate Result 2026 आज घोषित होगा!"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block opacity-60", children: "|" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-4 h-4 flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                "समय:",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-yellow-200 text-base tracking-widest", children: formatCountdown(countdown) }),
                " ",
                "में"
              ] })
            ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary text-secondary-foreground text-center py-2 px-4 text-sm font-medium", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-2", children: "🔔" }),
      "LIVE UPDATE: Bihar Board Inter Result 2026 — Aaj Announce Hoga | Official site:",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          ...
          children: "biharboardonline.bihar.gov.in"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "header",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 py-4 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-secondary flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-6 h-6 text-secondary-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-heading text-xl md:text-2xl font-bold tracking-tight leading-tight", children: "Prakash Enterprises" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/75 text-xs md:text-sm", children: "Bihar Board Result 2026 | Official Information Portal" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "nav",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "section",
        {
          ...
          style: {
            background: "linear-gradient(135deg, oklch(0.22 0.12 255) 0%, oklch(0.32 0.14 255) 60%, oklch(0.28 0.10 240) 100%)"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-96 h-96 rounded-full opacity-5 bg-secondary translate-x-1/2 -translate-y-1/2" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 w-64 h-64 rounded-full opacity-5 bg-secondary -translate-x-1/3 translate-y-1/3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-3xl mx-auto px-4 py-10 md:py-16 text-center text-primary-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 text-sm mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "w-4 h-4 text-secondary" }),
                "विश्वसनीय परिणाम पोर्टल — Server Down नहीं होगा"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-heading text-4xl md:text-5xl font-extrabold leading-tight mb-4", children: [
                "Bihar Board",
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "block text-secondary flex items-center justify-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-lg md:text-xl mb-6 max-w-xl mx-auto", children: "आज का दिन! Result कुछ ही देर में आएगा — अभी Roll Number तैयार रखें" }),
              !isLive && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-3 bg-white/10 border border-white/25 rounded-2xl px-6 py-3 mb-8", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-5 h-5 text-yellow-300" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/80 text-sm", children: "Result आने में:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-yellow-200 text-2xl font-bold tracking-widest", children: formatCountdown(countdown) })
              ] }),
              isLive && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center gap-2 bg-green-500/20 border border-green-400/40 rounded-2xl px-6 py-3 mb-8 animate-bounce", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-300 font-bold text-lg", children: "🟢 Result LIVE है! अभी Check करें!" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-6 md:p-8 shadow-2xl text-left max-w-xl mx-auto", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-heading text-xl font-bold text-foreground mb-5", children: "Result Check करें" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Button,
                    {
                      ...
                      className: `w-full h-12 text-base font-bold text-secondary-foreground rounded-lg mt-2 ${isLive ? "bg-green-600 hover:bg-green-700" : "bg-secondary hover:bg-secondary/90"}`,
                      style: isLive ? { animation: "pulse-badge 1s ease-in-out infinite" } : {},
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-4 text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "inline w-3.5 h-3.5 mr-1 text-yellow-500" }),
                  "यह portal आपको Official BSEB website पर redirect करेगा।"
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-black/30 border-t border-white/10 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "whitespace-nowrap text-white/85 text-sm py-2 px-4 font-medium",
                style: { animation: "marquee 30s linear infinite" },
                children: "📢 Bihar Board Intermediate Result 2026  |  Official Website: biharboardonline.bihar.gov.in  |  Roll Number Ready Rakhein  |  Server Down hone par backup links use karein  |  13 Lakh+ Students Ka Result Aaj Ghoshit Hoga  |  Prakash Enterprises — Aapka Bharosemand Result Portal  |  📢 Bihar Board Intermediate Result 2026  |  Official Website: biharboardonline.bihar.gov.in  |  Roll Number Ready Rakhein  |  Server Down hone par backup links use karein"
              }
            ) })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-6", children: stats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(stat.icon, { className: "w-6 h-6" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-heading text-2xl font-extrabold text-foreground", children: stat.value }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "servers", className: "py-12 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-primary/10 text-primary rounded-full px-4 py-1.5 text-sm font-semibold mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Server, { className: "w-4 h-4" }),
            "Multiple Server Links"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-2xl md:text-3xl font-bold text-foreground", children: "10 Official Servers — एक Down हो तो दूसरा Try करें" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-2 max-w-lg mx-auto", children: "Result Day पर servers slow हो सकते हैं। नीचे दिए गए सभी links आज़माएं।" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: servers.map((server, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: server.url,
                target: "_blank",
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "h-full border-2 hover:border-primary/50 hover:shadow-card transition-all duration-200 cursor-pointer", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pt-4 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-base font-semibold text-foreground group-hover:text-primary transition-colors leading-snug", children: server.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-4 h-4 text-muted-foreground flex-shrink-0 mt-0.5 group-hover:text-primary transition-colors" })
                  ] }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pb-4 px-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-green-600 text-xs font-medium", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-3.5 h-3.5" }),
                        "Live"
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-2 truncate", children: server.url.replace("https://", "") })
                  ] })
                ] })
              },
              server.url
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "how-to", className: "py-12 bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-primary/10 text-primary rounded-full px-4 py-1.5 text-sm font-semibold mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-4 h-4" }),
            "Step-by-Step Guide"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-2xl md:text-3xl font-bold text-foreground", children: "Result कैसे Check करें?" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: steps.map((step) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-heading font-bold text-lg flex-shrink-0", children: step.num }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base mb-1", children: step.title }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "dates", className: "py-12 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-primary/10 text-primary rounded-full px-4 py-1.5 text-sm font-semibold mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "w-4 h-4" }),
            "Important Dates"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-2xl md:text-3xl font-bold text-foreground", children: "BSEB Intermediate 2026 — महत्वपूर्ण तारीखें" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border-2 border-border overflow-hidden shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-primary", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-primary-foreground font-bold py-3", children: "Event" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-primary-foreground font-bold py-3", children: "Date" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-primary-foreground font-bold py-3", children: "Status" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: importantDates.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            TableRow,
            {
              className: `${row.status === "live" ? "bg-red-50" : i % 2 === 0 ? "bg-background" : "bg-muted/50"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  TableCell,
                  {
                    className: `font-medium py-3 ${row.status === "live" ? "text-red-700 font-bold" : "text-foreground"}`,
                    children: row.event
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  TableCell,
                  {
                    className: `py-3 ${row.status === "live" ? "text-red-700 font-bold" : "text-foreground"}`,
                    children: row.date
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "py-3", children: row.status === "done" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-green-100 text-green-800 border-green-200 hover:bg-green-100", children: "Completed" }) : row.status === "live" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Badge,
                  {
                ...
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-yellow-100 text-yellow-800 border-yellow-200 hover:bg-yellow-100", children: "Upcoming" }) })
              ]
            },
            row.event
          )) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: highlights.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "bg-white rounded-xl p-5 border border-border flex items-start gap-4 shadow-xs",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: "w-5 h-5 text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-1", children: item.title }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-primary text-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 py-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row justify-between items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-heading font-bold text-lg", children: "Prakash Enterprises" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/70 text-sm mt-1", children: "Bihar Board Result 2026 Information Portal" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-primary-foreground/70 text-xs max-w-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Disclaimer:" }),
          " यह एक informational portal है। Result data Official BSEB website से provide किया जाता है। हम किसी भी result accuracy की guarantee नहीं देते।"
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10 mt-6 pt-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-primary-foreground/60 text-sm", children: [
        "© ",
        currentYear,
        " Prakash Enterprises. Built with ❤️ using",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
